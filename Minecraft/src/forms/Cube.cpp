...
namespace form {
	...
	const GLfloat CubeData::datas[] = {
        // Front v0,v1,v2,v3
         ...
         // Right v2,v3,v4,v5
           1.f,  1.f,  0.f,              1.f, 1.f, 2.f,
           1.f,  1.f,  1.f,              1.f, 0.f, 2.f,
           1.f,  0.f,  1.f,              0.f, 0.f, 2.f,
           1.f,  0.f,  0.f,              0.f, 1.f, 2.f,
          // Top v1,v2,v5,v6	
           0,  1.f,  0.f,              1.f, 1.f, 3.f,
           1.f,  1.f,  0.f,              0.f, 1.f, 3.f,
           1.f,  1.f,  1.f,              0.f, 0.f, 3.f,
           0.f,  1.f,  1.f,              1.f, 0.f, 3.f,
          // Left v0,v1,v6,v7	
           0,  0.f,  0.f,             0.f, 1.f, 4.f,
           0.f,  1.f,  0.f,             1.f, 1.f, 4.f,
           0.f,  1.f,  1.f,             1.f, 0.f, 4.f,
           0.f,  0.f,  1.f,             0.f, 0.f, 4.f,
          // Bottom v0,v3,v4,v7
          ...
          // Back v4,v5,v6,v7	
           1,  0.f,  1.f,              1.f, 0.f, 6.f,
           1.f,  1.f,  1.f,              0.f, 0.f, 6.f,
           0.f,  1.f,  1.f,              0.f, 1.f, 6.f,
           0.f,  0.f,  1.f,              1.f, 1.f, 6.f 
    };
